...
function updateUi(usersSelected, algorithmSelected, selMGF, selAS, selFS, selDF) {
    ...
    inner += '</ul>';
    inner += '<p>According to the Algorithm <span>' + algorithmSelected + '</span>, The Ideal Festival designed for the group of users selected ';
    if (selMGF != null) {
    ...
    document.querySelector('.main-group').innerHTML += '<a href="/3" class="button reverse">RE-INITIALIZE RECOMMENDATION</a>'
